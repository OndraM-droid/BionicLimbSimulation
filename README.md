...
A browser-based real-time EMG playback and gesture classification simulator for a bionic hand prosthetic.
...
- **Classification**: ML (ONNX via onnxruntime-web) with automatic rule-based fallback
- **Playback timing**: accumulator-based, sample-accurate replay at original 200 Hz rate
- **Hand rig**: 14-bone Three.js skeleton, Slerp blending, ROM-clamped per joint
